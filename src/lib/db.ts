...
const settlementsOnTagsSelect =
  Prisma.validator<Prisma.SettlementsOnTagsSelect>()({
    tag: {
      select: tagsSelect,
    },
  });
...
const settlementsSelectWithLocations =
  Prisma.validator<Prisma.SettlementsSelect>()({
    ...settlementsSelect,
    location: {
...
const settlementsOnArchitectsSelect =
  Prisma.validator<Prisma.SettlementsOnArchitectsSelect>()({
    architect: {
...
const settlementsOnSettlementTypesSelect =
  Prisma.validator<Prisma.SettlementsOnSettlementTypesSelect>()({
    settlementType: {
      select: settlementTypesSelect,
    },
  });

export type SettlementsOnTagsSelect = Prisma.SettlementsOnTagsGetPayload<{
  select: typeof settlementsOnTagsSelect;
}>;
...
export type SettlementsOnArchitectsSelect =
  Prisma.SettlementsOnArchitectsGetPayload<{
    select: typeof settlementsOnArchitectsSelect;
  }>;
...
export type SettlementsOnSettlementTypesSelect =
  Prisma.SettlementsOnSettlementTypesGetPayload<{
    select: typeof settlementsOnSettlementTypesSelect;
  }>;
...
export const externalLinksInclude =
  Prisma.validator<Prisma.ExternalLinksInclude>()({
    platform: true,
  });
...
export const resourceTypesInclude =
  Prisma.validator<Prisma.ResourceTypesInclude>()({
    resources: true,
  });
...
export const settlementsOnTagsInclude =
  Prisma.validator<Prisma.SettlementsOnTagsInclude>()({
    tag: {
      select: tagsSelect,
    },
    settlement: {
...
export const settlementsOnArchitectsInclude =
  Prisma.validator<Prisma.SettlementsOnArchitectsInclude>()({
    architect: {
      select: architectsSelect,
    },
    settlement: {
...
export type LocationsInclude = Prisma.LocationsGetPayload<{
  include: typeof locationsInclude;
}>;
export type EventsInclude = Prisma.EventsGetPayload<{
  include: typeof eventsInclude;
}>;
export type DetailsInclude = Prisma.DetailsGetPayload<{
  include: typeof detailsInclude;
}>;
export type ResourcesInclude = Prisma.ResourcesGetPayload<{
  include: typeof resourcesInclude;
}>;
export type ArchitectsInclude = Prisma.ArchitectsGetPayload<{
  include: typeof architectsInclude;
}>;
export type ExternalLinksInclude = Prisma.ExternalLinksGetPayload<{
...
export type SettlementsInclude = Prisma.SettlementsGetPayload<{
  include: typeof settlementsInclude;
}>;
export type SettlementsOnTagsInclude = Prisma.SettlementsOnTagsGetPayload<{
  include: typeof settlementsOnTagsInclude;
}>;
export type SettlementsOnArchitectsInclude =
  Prisma.SettlementsOnArchitectsGetPayload<{
    include: typeof settlementsOnArchitectsInclude;
  }>;
export type TagsInclude = Prisma.TagsGetPayload<{
  include: typeof tagsInclude;
}>;
export type EventTypesInclude = Prisma.EventTypesGetPayload<{
  include: typeof eventTypesInclude;
}>;
export type DetailTypesInclude = Prisma.DetailTypesGetPayload<{
  include: typeof detailTypesInclude;
}>;
export type ResourceTypesInclude = Prisma.ResourceTypesGetPayload<{
